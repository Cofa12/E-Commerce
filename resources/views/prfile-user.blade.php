...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('css/profile-user.css')}}">
...
<body>
    <div class="main">
        <div>
            <img src="{{'../../images/'.$user_picture}}" alt="">
            <span>{{$user_name}}</span>
        </div>
    </div>
    <div class ="info">
        ...
        <form action="{{route('updateuser.info')}}" method="post">
            ...
            <input type="text" name="name" id="" class="need" value="{{$user_name}}">

            <label for="">Your Email</label>
            <input type="text" name="email" id="" class="need" value="{{$user_email}}">
    ...
    <div class="content">
        ...
        <div class='item_div'>
            ...
            <div class ="photo_div">
            @foreach($conditoin =$userproduct->where('order_id','=',$order->id) as $item)
                <img src="{{'../../manimages/'.$item->product->product_picture}}" alt="">
            @endforeach
        </div>
        </div>
        @endforeach
